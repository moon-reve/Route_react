...
const FAQ = [
  {
    q: '루트는 어떤 서비스인가요?',
    a: 'Route는 커리어 전환을 준비하는 분들을 위한 앱이에요.\n\n개인화된 AI 학습 루트를 제공하고, 스스로 학습 기록을 남기거나 외부 강의도 기록할 수 있어요. 이직에 필요한 모든 것을 한 곳에서 관리해보세요!',
  },
  {
    q: '프리스텝은 꼭 해야 하나요?',
    a: '프리스텝을 하지 않아도 Route 서비스는 이용할 수 있어요! 단, 프리스텝을 완료하면 개인화된 AI 서비스를 통해 나에게 딱 맞는 맞춤형 커리큘럼을 제공받을 수 있어요. 5단계로 구성되어 있고 5분이면 충분하니 하는 걸 추천드려요! 😊',
  },
  {
    q: '로그는 어떻게 쓰나요?',
    a: '하단 중앙의 ✏️ 버튼을 눌러 로그를 작성할 수 있어요. 오늘 학습한 내용, 느낀 점 등을 자유롭게 기록해보세요. 꾸준히 쌓인 기록은 나중에 면접 준비할 때 큰 도움이 될 거예요!',
  },
  {
    q: '저장한 아티클은 어디서 볼 수 있나요?',
