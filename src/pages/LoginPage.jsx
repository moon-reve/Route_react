      ...
      <svg className="login-bg" viewBox="0 0 430 932" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
        <g clipPath="url(#lclip)">
          ...
          <g className="login-ring">
            ...
            {/* 고리 끝 장식 */}
            <path opacity="0.55" d="M116.085 504.134C118.065 504.134 119.671 502.528 119.671 500.547C119.671 498.567 118.065 496.961 116.085 496.961C114.104 496.961 112.498 498.567 112.498 500.547C112.498 502.528 114.104 504.134 116.085 504.134Z" fill="white" stroke="#1A1C1E" strokeWidth="0.860779"/>
